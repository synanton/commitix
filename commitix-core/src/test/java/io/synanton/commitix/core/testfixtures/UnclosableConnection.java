...
/**
 * Wraps a {@link Connection} and makes {@link #close()} a no-op so the test retains control.
 */
final class UnclosableConnection implements Connection {

    private final Connection delegate;

    UnclosableConnection(Connection delegate) {
        this.delegate = delegate;
    }

    /** No-op: the test controls the lifecycle of the underlying connection. */
    @Override
    public void close() {
    }
    ...
    public PreparedStatement prepareStatement(
            String sql, int rsType, int rsConcurrency, int rsHoldability) throws SQLException {
